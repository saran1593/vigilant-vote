      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-6 mb-10 pb-6 border-b border-white/15">
          <div>
            ...
            <p className="text-slate-300 text-sm mt-1">Grievance audit and management</p>
          </div>
                ...
                <div className="bg-slate-900/60 backdrop-blur-2xl border border-white/20 p-8 sm:p-10 rounded-[2.5rem] shadow-2xl animate-in fade-in slide-in-from-right duration-300">
                  <div className="flex flex-wrap justify-between items-start mb-8 pb-8 border-b border-white/15 gap-4">
                    ...
                    <div className="flex gap-2">
                      <button onClick={() => updateStatus(selectedComplaint.complaintId, 'investigating')} className="px-4 py-2.5 rounded-xl border border-white/20 bg-slate-950/50 text-xs font-bold hover:bg-white/10 transition-all">Mark Investigating</button>
                      <button onClick={() => updateStatus(selectedComplaint.complaintId, 'resolved')} className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-bold hover:opacity-90 transition-all shadow-md shadow-emerald-600/30">Mark Resolved</button>
                    </div>
                  </div>
